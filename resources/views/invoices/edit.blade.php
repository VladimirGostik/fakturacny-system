...
<div class="max-w-4xl mx-auto space-y-6">
    ...
    <form method="POST" action="{{ route('invoices.update', $invoice) }}">
        ...
        <div class="mt-6">
            ...
            <textarea id="desc_above_service" name="desc_above_service" class="mt-1 block w-full">{{ $invoice->services->first()->desc_above_service }}</textarea>
        </div>
        ...
        <div>
            <x-input-label for="desc_services" :value="__('Veta nad sluzby:')" class="text-lg"  />
            <x-text-input id="desc_services" name="desc_services" type="text" class="mt-1 block w-full"  value="{{ $invoice->desc_services }}" />
        </div>
